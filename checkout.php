...
$alamat = strtolower(trim($_POST['alamat'] ?? ''));
...
if ($process == 'login') {
    ...
    if (validValue($nama) & validValue($alamat) & validValue($telpon) & validValue($password_register) & validValue($email_register)) {
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input type="text" name="telpon" required placeholder="Nomor Telepon / Whatsapp" class="checkout__input__add" value="<?= $_SESSION['daftar']['telpon'] ?? '' ?>" />
