...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="../admin/asset/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="../admin/asset/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" href="../admin/asset/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
  ...
  <link rel="stylesheet" href="../admin/asset/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../admin/asset/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="main.php?pages=messages" class="nav-link">KOTAK SURAT</a>
      </li>
    </ul>
