      ...
      echo "<a href=../../index.php><b>LOGIN</b></a></center>";
        ...
        if(isset($_POST['change'])){  
            ...
            if ($old_password != $_SESSION['password']) {
                ...
                echo "<script>window.location = '$reseller_url'+'main.php?module=password';</script>";          
                ...
                if($query) {
                    echo"<script> alert('Password Berhasil Diubah'); window.location = '$reseller_url'+'main.php?module=password'; </script>";
                } else {
                    echo"<script> alert('Password Gagal Diubah'); window.location = '$reseller_url'+'main.php?module=password'; </script>";
                }
            }
        }  
    }  
