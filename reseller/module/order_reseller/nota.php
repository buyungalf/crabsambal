...
$disc        = ($item['diskon']/100)*$item['harga_reseller'];
$hargadisc   = number_format(($item['harga_reseller']-$disc),0,",","."); 
$subtotal    = ($item['harga_reseller']-$disc) * $item['jumlah'];

$total       = $total + $subtotal;
$subtotal_rp = format_rupiah($subtotal);    
$total_rp    = format_rupiah($total);    
$harga       = format_rupiah($item['harga_reseller']);
...
<td><?= $item['jumlah'] ?></td>
<td class="cost">Rp<?= format_rupiah($item['harga_reseller']) ?></td>
...
<div style="text-align: center">
	<a class="" href="/crabsambal/admin/module/laporan/pdf_order_reseller.php?id_orders=<?= $id_orders ?>">Cetak</a>	
</div>
