...
<div class="col-12">
  <div class="card">
    ...
    <!-- /.card-header -->
    <form action="module/order_reseller/aksi.php" method="post">
    <?php
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>            
            ...
            <td><?= $item['berat'] ?></td>
            <td><?= $item['jumlah'] ?></td>
            <td><?= $item['harga_reseller'] ?></td>
            <td><?= $item['harga_reseller']*$item['jumlah'] ?></td>
            <td><a href="<?= $reseller_url; ?>module/order/aksi.php?id_produk=<?= $item['id_produk']; ?>&jumlah=<?= $item['jumlah'] ?>&aksi=hapus_item" class="btn btn-danger"><i class="fas fa-trash"></i></a></td>
          </tr>
           <?php $i++; } ?>
        </tbody>
      </table>
